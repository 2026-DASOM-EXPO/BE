...
public enum ErrorCode {
    ...
    FFMPEG_NOT_AVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "FFMPEG_NOT_AVAILABLE", "FFmpeg 실행 파일을 찾거나 실행할 수 없습니다."),
    DRONE_STREAM_START_FAILED(HttpStatus.BAD_GATEWAY, "DRONE_STREAM_START_FAILED", "드론 카메라 영상 스트림을 시작하지 못했습니다."),
    DRONE_STREAM_START_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "DRONE_STREAM_START_TIMEOUT", "드론 영상의 HLS 변환 준비 시간이 초과되었습니다."),
    INVALID_DRONE_STREAM_KEY(HttpStatus.BAD_REQUEST, "INVALID_DRONE_STREAM_KEY", "올바르지 않은 드론 스트림 식별자입니다."),
